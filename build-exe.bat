...
rem Обязательны при распространении: sing-box — GPL-3.0 (§4/§6 требуют передавать
rem текст лицензии и обеспечивать доступ к исходникам), Xray-core — MPL-2.0 (§3.2

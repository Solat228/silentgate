...
class SiteFaviconService {
  ...
  static Future<String?> _resolve(String domain) async {
    try {
      ...
      //    работает там, где типовые пути пустые (nalog.ru и т.п.).
      ...
      //    даже там, где у сайта только .ico — напр. nalog.ru, steam.com).
      final sources = <String>[
        ...
        // (nalog.ru, steam.com), где прямые пути и Google s2 пустуют.

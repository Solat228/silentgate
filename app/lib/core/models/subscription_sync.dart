...
class SubscriptionSyncResult {
  ...
  /// «DE-1 (***.***.***.***)». Имя адрес из ссылки не содержит, проверка «имя
  ...
  /// символами не являются, поэтому «NL-185.199.108.153» и «DE1-***.***.***.***»
  ...
  ///
  /// Скользящее окно, а не разбор куска целиком: «v1.***.***.***.***» — это тот же

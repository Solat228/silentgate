...
/// сервис ЧЕРЕЗ сервер.
///
/// На Android — нет: `LibXray.ping` поднимает свой экземпляр ядра и гасит его
/// сразу, порта наружу не отдавая. Признак нужен ИНТЕРФЕЙСУ, чтобы сказать об
/// этом сразу, а не после того, как человек настроил стратегию и нажал «Начать».

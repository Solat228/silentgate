...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get serviceChecksLayoutTitle =>
      'Diseño de comprobaciones de servicios';

  @override
  String get serviceChecksLayoutAdaptive => 'Adaptable';

  @override
  String get serviceChecksLayoutRows => 'Filas debajo del botón';

  @override
  String get serviceChecksLayoutSides => 'Columnas junto al botón';

  @override
  String get serviceChecksLayoutGrid => 'Cuadrícula compacta junto al botón';
  ...
  String get tunnelExcludeScopeTitle =>
      'Direcciones de servidor evitan el túnel';

  @override
  String get tunnelExcludeScopeAllKnown =>
      'Todos los servidores de suscripción';

  @override
  String get tunnelExcludeScopeAllKnownHint =>
      'Ping honesto para toda la lista. Las búsquedas de direcciones de servidor evitan el túnel, usando su dirección real.';

  @override
  String get tunnelExcludeScopeActiveOnly => 'Solo servidor activo';

  @override
  String get tunnelExcludeScopeActiveOnlyHint =>
      'Solo el servidor al que está conectado evita el túnel. El ping para otros servidores con VPN habilitado será inexacto, y los cambios de servidor sin problemas recrearán el túnel.';

  @override
  String get tunnelExcludeScopeOff => 'No excluir';

  @override
  String get tunnelExcludeScopeOffHint =>
      'Las direcciones del servidor no están en la tabla de enrutamiento, pero el ping con VPN habilitado muestra la latencia hacia la pila local, no al servidor.';
  ...
  @override
  String get subBarAnnounce => 'Anuncio del panel';

  @override
  String subBarAnnounceFrom(String name) {
    return 'Anuncios del servicio $name';
  }

  @override
  String get subBarAnnounceFromUnnamed => 'Anuncios del servicio';

  @override
  String get hideAnnounceTitle => 'Ocultar anuncios del servicio';

  @override
  String get hideAnnounceSub =>
      'Los anuncios de la suscripción no se muestran en la tarjeta. Por defecto se ven en cualquier pantalla.';
  ...
  String get infoAutoReconnect =>
      'Si el núcleo se cayó, el servidor se desconectó o cambió la red (Wi-Fi ↔ cable, salida de suspensión, nueva IP), la aplicación restablece la conexión por sí sola. Las pausas entre intentos aumentan: 0,8 s → 3 s → 8 s → 20 s, y a partir de ahí se mantienen en 20 s. Hay ocho intentos, tras los cuales la aplicación se rinde y muestra un error. Desconectar con el botón siempre cancela la recuperación.\n\n⚠️ Con el kill switch activado, los intentos NO SE AGOTAN. Mientras continúan, el tráfico permanece bloqueado, y detenerlos significaría dejarlo salir fuera de la VPN, así que la aplicación sigue intentándolo cada 20 segundos hasta que apagues la VPN tú mismo, y te recuerda el fallo como mucho una vez cada 15 minutos. Un servidor que vuelve una hora después se retoma solo.\n\nEn el modo «Auto (mejor servidor)» la aplicación no gasta el último intento en un servidor muerto: ya en el séptimo de ocho pasa al siguiente candidato, y allí la cuenta empieza de nuevo.\n\nEl cambio de red se detecta por las direcciones reales de los demás adaptadores: el propio túnel y las direcciones de servicio (link-local) no se tienen en cuenta, un cambio solo se acepta si se mantuvo durante dos sondeos seguidos, y la señal se ignora durante los primeros 15 segundos tras conectar. Sin estas salvaguardas, levantar el túnel se contaría a sí mismo como un «cambio de red» y provocaría una reconexión infinita.';
  ...
  String get tunLogLevelDebugCost =>
      'En el nivel debug el núcleo escribe cientos de líneas por segundo: el registro abarca minutos, no horas, y crece en megabytes. No sirve para un corte anterior: consulte el registro de la aplicación.';
  ...
  String serverUnsupportedHy2Mask(String type) {
    return 'El camuflaje «$type» todavía no es compatible con este cliente';
  }

  @override
  String get serverUnsupportedGeneric =>
      'Este servidor todavía no es compatible con este cliente';
  ...
  String get pingCoreTooltip =>
      'Medido por el propio núcleo VPN a través del túnel: tiempo total de la solicitud a la URL de prueba (no la latencia TCP al servidor). El servidor funciona: la solicitud pasó.';

  @override
  String get pingCoreFailedTooltip =>
      'El núcleo VPN no pudo abrir la URL de prueba a través de este servidor: el tráfico no pasa por el túnel';

  @override
  String get pingViaTunnelNote =>
      'Cifra oculta: la medición se hizo con la VPN activa y respondió el túnel local, no el servidor. Desconecte la VPN para una medición TCP honesta.';
  ...
  String get serviceChecksInfo =>
      'Dos iconos por servicio\n• izquierda: el servicio sin VPN\n• derecha: el mismo servicio con VPN\n• flecha entre ambos: el cambio\n\nCuándo se toma la medición\n• sin VPN: sola al iniciar la app\n• con VPN: justo después de conectar\n\nColor del anillo alrededor del icono\n• verde: abre\n• naranja: bloqueo por país\n• rojo: inaccesible\n• gris: aún sin comprobar\n\nLa marca de la esquina repite el color\n• ✓ abre\n• ! bloqueo por país\n• ✕ inaccesible\n\nQué se puede pulsar\n• el icono: comprobar el servicio de nuevo\n• el botón de ajustes de al lado: cambiar el conjunto de servicios';
  ...
  String get errServerUnsupported =>
      'Este servidor no es compatible con este cliente';
  ...
  String get autoWarnNoRealIp =>
      '«Nunca usar la IP real» está activado: tus reglas «Directo» pasan por la VPN.';
  ...
  String get speedStaleServerTooltip =>
      'El servidor no responde ahora mismo: se muestra una medición de velocidad anterior';

  @override
  String get speedOlderThanPingTooltip =>
      'La medición de velocidad es anterior a la última comprobación';
  ...
  String get speedWaitsForPing =>
      'Ping en curso: la prueba de velocidad comenzará justo después';
  ...
  @override
  String get srvInfoSectionSession => 'Conexión actual';

  @override
  String get srvInfoSessionUptime => 'Tiempo de conexión';
  ...
  String get noRealIpSubRulesOnly =>
      'Solo reescribe tus reglas «Directo»: pasan por el túnel (también los sitios RU). No cambia la ruta por defecto; la red local sigue siendo directa.';

  @override
  String get noRealIpOnlySelectedNote =>
      'En el modo «Solo los seleccionados», todo lo no seleccionado sigue saliendo con tu IP real: esta opción no lo cambia.';

  @override
  String get infoNoRealIp =>
      'Se aplica SOLO a las reglas «Directo» explícitas (aplicaciones y sitios) y a las reglas directas de la configuración del panel: se llevan al túnel. Una regla con «Permitir IP real» marcada sigue siendo directa.\n\nLo que NO hace: no cambia la ruta por defecto. En el modo «Solo los seleccionados» la ruta por defecto sigue siendo directa, así que todo el tráfico no seleccionado sale con tu dirección real, independientemente de esta opción. Si todo debe estar cubierto, usa «Todo a través de la VPN».\n\nLa red local siempre queda directa.';

  @override
  String get killSwitchSubProxyNoAdmin =>
      'Esto no es un bloqueo real: en el modo «Proxy del sistema» no se piden permisos de administrador y lo único que se hace es dejar el proxy configurado. Los programas que lo ignoran y todo el UDP salen directamente. Solo TUN retiene todo.';

  @override
  String get killSwitchOfferTun =>
      'El bloqueo completo durante un corte solo existe en el modo TUN.';

  @override
  String get splitOnlySelectedWarnTitle =>
      'Todo lo no seleccionado sale con tu IP real';

  @override
  String get splitOnlySelectedWarnBody =>
      'Solo entra en el túnel lo que tiene la acción «Túnel». El resto del tráfico —incluidos programas de los que no sabes nada— sale directamente, con tu dirección real. Si hay que ocultar todo el dispositivo, elige «Todo a través de la VPN».';

  @override
  String get splitOnlySelectedNoRealIp =>
      'La opción «No salir con la IP real» no cambia esto: solo reescribe las reglas «Directo», no la ruta por defecto.';
  ...
  @override
  String get splitImportOk => 'Ajustes importados';

  @override
  String get splitImportBad =>
      'No hay ajustes válidos de SilentGate en el portapapeles';

  @override
  String get splitImportReplace => 'Reemplazar';

  @override
  String get splitImportConfirm =>
      '¿Reemplazar las reglas actuales de túnel dividido por las importadas?';
  ...
  @override
  String get updatesChannelStable => 'Canal estable';

  @override
  String get updatesChannelBeta => 'Canal beta';

  @override
  String get updatesCheckNow => 'Comprobar ahora';

  @override
  String get updatesStatusChecking => 'Comprobando…';

  @override
  String get updatesStatusUpToDate => 'Tienes la última versión';
  ...
  @override
  String get updatesStatusVerifying => 'Verificando la firma…';

  @override
  String get updatesStatusReady => 'Listo para instalar';
  ...
  String get updatesStatusNeedsPermission =>
      'Se necesita permiso para instalar';

  @override
  String get updatesStatusLinkOnly => 'Instala manualmente';

  @override
  String get updatesModeTitle => 'Cómo actualizar';

  @override
  String get updatesModeAsk => 'Preguntar';

  @override
  String get updatesModeAskHint =>
      'Muestra las novedades e instala solo tras tu confirmación';

  @override
  String get updatesModeAuto => 'Automáticamente';

  @override
  String get updatesModeAutoHint =>
      'Descarga e instala por sí solo cuando la VPN está apagada';

  @override
  String get updatesModeNotify => 'Solo avisar';

  @override
  String get updatesModeNotifyHint =>
      'Informa de la nueva versión sin descargar ni instalar nada';

  @override
  String get updatesAutoCheck => 'Comprobar al iniciar';

  @override
  String get updatesBeta => 'Recibir versiones beta';

  @override
  String get updatesSignatureNote =>
      'Cada archivo se verifica con la firma del desarrollador y una suma de comprobación; sin coincidencia, la instalación no comenzará';
  ...
  @override
  String get updatesInstall => 'Actualizar';

  @override
  String get updatesLater => 'Más tarde';

  @override
  String get updatesSkipVersion => 'Omitir esta versión';

  @override
  String get updatesVpnWarning => 'La instalación cortará la conexión VPN';

  @override
  String get updatesAndroidUnknownSources =>
      'Permite la instalación desde esta aplicación';

  @override
  String get updatesAndroidOpenSettings => 'Abrir ajustes';

  @override
  String get updatesAndroidNoSilent =>
      'Android mostrará la ventana de instalación del sistema: es un requisito del sistema';

  @override
  String get updatesPortableFallback =>
      'Esta copia no se instaló con el instalador. Descarga la nueva versión manualmente';

  @override
  String updatesInstalledToast(String version) {
    return 'Actualizado a $version';
  }

  @override
  String get updatesInstallFailedTitle => 'La instalación no se completó';

  @override
  String updatesInstallFailedBody(String version) {
    return 'La versión sigue siendo $version. Registro del instalador abajo';
  }
  ...
  String get updatesOverrideBadge =>
      'Fuente de actualizaciones sustituida (modo de prueba)';

  @override
  String get updatesSettingsTile => 'Actualizaciones';

  @override
  String get updatesSettingsTileSubtitle =>
      'Comprobación, descarga e instalación de nuevas versiones';

  @override
  String get updatesPreviousVersions => 'Versiones anteriores';
  ...
  String get updatesDowngradeWarning =>
      'Volver a una versión anterior. ¿Continuar?';
  ...
  String get updatesVpnWarningBody =>
      'La aplicación se cerrará y la VPN se desconectará durante la instalación. Vuelva a conectarse después de la actualización';

  @override
  String get updatesOpenPage => 'Abrir página de descarga';

  @override
  String get updatesLinkNotify =>
      'Está seleccionado el modo «Solo avisar»: descargue la nueva versión desde la página de descarga';

  @override
  String get updatesLinkNoSelfUpdate =>
      'Esta versión no incluye un instalador firmado para su sistema: descárguelo desde la página de descarga';

  @override
  String get updatesLinkIsolated =>
      'Esta es una copia de prueba aislada: no modifica la aplicación instalada. Actualice manualmente';

  @override
  String get updatesLinkLocation =>
      'La aplicación no se ejecuta desde su carpeta de instalación: descargue la nueva versión manualmente o abra la copia instalada';

  @override
  String get updatesLinkElevated =>
      'La aplicación se ejecuta como administrador: actualizar así no es seguro. Iníciela de forma normal';

  @override
  String get updatesLinkUnsupported =>
      'En esta plataforma la aplicación no puede actualizarse sola: descargue la nueva versión manualmente';

  @override
  String get updatesErrCheck => 'el servidor de actualizaciones no respondió';

  @override
  String get updatesErrInsecure =>
      'la dirección de descarga no es segura (no es https)';

  @override
  String get updatesErrAssetName =>
      'el nombre de archivo de la versión no es válido';

  @override
  String get updatesErrManifest =>
      'no se pudo obtener el manifiesto firmado de la versión';

  @override
  String get updatesErrSignature =>
      'la firma no coincide: el archivo podría haber sido alterado';

  @override
  String get updatesErrManifestRejected =>
      'el manifiesto de la versión no corresponde a esta versión o sistema';

  @override
  String get updatesErrDownload =>
      'el archivo no se descargó o su suma de comprobación no coincide';

  @override
  String get updatesErrInstall => 'el instalador no se inició';

  @override
  String get updatesErrNotNewer =>
      'esta versión no es más reciente que la instalada';

  @override
  String get updatesInfo =>
      'Qué hace la aplicación cuando encuentra una nueva versión. En modo automático la instalación nunca corta una VPN activa: espera a que se desconecte. En cualquier modo, un archivo solo se instala si coincide la firma del desarrollador.';

  @override
  String get updatesDownload => 'Descargar';

  @override
  String get updatesInstallNow => 'Instalar ahora';

  @override
  String get updatesWaitingVpn =>
      'Listo para instalar: empezará cuando se desconecte la VPN';

  @override
  String updatesSkippedNote(String version) {
    return 'Versión $version omitida: le avisaremos de la siguiente';
  }

  @override
  String get updatesAutoNoticeTitle => 'Instalando actualización';

  @override
  String updatesAutoNoticeBody(String version) {
    return 'La aplicación se cerrará mientras se instala la versión $version';
  }
}

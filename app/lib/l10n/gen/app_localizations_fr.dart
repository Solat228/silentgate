...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get infoAppUpdateBeta =>
      'L\'application commencera à consulter la liste complète des versions GitHub, préversions incluses, et non plus seulement la dernière version stable. Le canal principal de mise à jour automatique ne change pas : la bêta n\'arrivera pas à ceux qui n\'ont pas activé cette option.';

  @override
  String get appUpdateBetaBadge => 'BÊTA';

  @override
  String get appUpdatePreviousVersionsHint =>
      'Cette liste correspond à ce qui se trouve dans GitHub Releases. Certaines versions peuvent manquer.';

  @override
  String get appUpdatePreviousVersionsEmpty =>
      'Liste vide : GitHub Releases est inaccessible ou ne contient aucune version.';

  @override
  String get appUpdateOpenRelease => 'Ouvrir la page de la version';
  ...
  @override
  String get connectButtonConnect => 'Connecter';

  @override
  String get connectButtonDisconnect => 'Déconnecter';
  ...
  @override
  String get homeAutoBest => 'Choisir un serveur';

  @override
  String get homeAutoSession => 'Auto (meilleur serveur)';

  @override
  String homeAutoBestHint(int count) {
    return 'testera les $count et se connectera au meilleur';
  }

  @override
  String get homeAutoConfig => 'Choisir la configuration';
  ...
  String get subSwitcherPingBusySpeed =>
      'Ping indisponible : un test de débit est en cours';
  ...
  String subSwitcherCountChecking(int total) {
    return 'Serveurs dans l\'abonnement : $total. La vérification est en cours — le nombre de serveurs fonctionnels apparaîtra à la fin.';
  }

  @override
  String subSwitcherCountPartial(int total, int working) {
    return 'Serveurs dans l\'abonnement : $total. La vérification n\'est pas allée à son terme (annulée ou interrompue), le nombre est donc incomplet : $working ont passé le test du canal parmi ceux qui ont pu être atteints.';
  }
  ...
  String get infoAutoReconnect =>
      'Si le noyau a planté, si le serveur est tombé ou si le réseau a changé (Wi-Fi ↔ câble, sortie de veille, nouvelle IP), l\'application rétablit la connexion toute seule. Les pauses entre les tentatives augmentent : 0,8 s → 3 s → 8 s → 20 s, puis restent à 20 s. Il y a huit tentatives, après quoi l\'application abandonne et affiche une erreur. Se déconnecter avec le bouton annule toujours la récupération.\n\n⚠️ Avec le kill switch activé, les tentatives NE S\'ÉPUISENT JAMAIS. Tant qu\'elles continuent, le trafic reste bloqué, et les arrêter reviendrait à le laisser sortir hors du VPN — l\'application continue donc d\'essayer toutes les 20 secondes jusqu\'à ce que vous coupiez le VPN vous-même, et ne rappelle l\'échec qu\'une fois toutes les 15 minutes au maximum. Un serveur qui revient une heure plus tard est repris automatiquement.\n\nEn mode « Auto (meilleur serveur) », l\'application ne gaspille pas la dernière tentative sur un serveur mort : dès la septième sur huit, elle passe au candidat suivant, et le compte y repart de zéro.\n\nLe changement de réseau est détecté d\'après les adresses réelles des autres adaptateurs : votre propre tunnel et les adresses de service (link-local) ne comptent pas, un changement n\'est accepté que s\'il a tenu deux sondages d\'affilée, et le signal est ignoré pendant les 15 premières secondes après la connexion. Sans ces garde-fous, l\'établissement du tunnel se compterait lui-même comme un « changement de réseau » et provoquerait une reconnexion sans fin.';
  ...
  String get pingCoreTooltip =>
      'Mesuré par le cœur VPN lui-même à travers le tunnel : temps total de la requête vers l\'adresse de test (pas la latence TCP vers le serveur). Le serveur fonctionne — la requête est passée.';

  @override
  String get pingCoreFailedTooltip =>
      'Le cœur VPN n\'a pas pu ouvrir l\'adresse de test via ce serveur — le trafic ne passe pas par le tunnel';

  @override
  String get pingViaTunnelNote =>
      'Chiffre masqué : la mesure a eu lieu avec le VPN actif, c\'est le tunnel local qui a répondu, pas le serveur. Déconnectez le VPN pour une mesure TCP honnête.';
  ...
  String get homeServerInfo =>
      'D\'où sort ce serveur : adresse, pays, fournisseur, vitesse';
  ...
  @override
  String get geoWhy =>
      'Les fichiers geoip.dat et geosite.dat sont des listes d\'adresses par pays et de domaines par catégorie. Le cœur s\'en sert pour interpréter les règles du type geoip:ru et geosite:category-ads que définit le panneau de l\'abonnement. Sans ces fichiers, ces règles sont retirées de la configuration.';
  ...
  @override
  String get geoFileMissing => 'fichier absent';

  @override
  String get geoFileCorrupt => 'fichier endommagé — le cœur ne le lira pas';
  ...
  @override
  String get geoCheck => 'Vérifier les mises à jour';

  @override
  String get geoCheckAgain => 'Vérifier à nouveau';

  @override
  String get geoChecking => 'Consultation de la dernière version…';
  ...
  @override
  String get geoNeverChecked => 'Les mises à jour n\'ont jamais été vérifiées';

  @override
  String geoUpdateAvailable(String files, String size) {
    return 'Mise à jour disponible : $files — $size';
  }

  @override
  String get geoSizeUnknown => 'taille non communiquée par le serveur';

  @override
  String get geoUpToDate =>
      'Aucune mise à jour nécessaire : les fichiers correspondent à la dernière version publiée.';

  @override
  String get geoPlanTitle => 'Télécharger les bases géo ?';

  @override
  String get geoPlanTitleUpdate => 'Mettre à jour les bases géo ?';

  @override
  String geoPlanFiles(String files) {
    return 'Fichiers : $files';
  }
  ...
  String get geoPlanTraffic =>
      'Les fichiers passeront par votre connexion. Sur un forfait mobile, cela représente un volume notable.';
  ...
  String get geoErrorNetwork =>
      'Impossible de joindre le serveur de mises à jour. Vérifiez votre connexion Internet et réessayez.';

  @override
  String get geoErrorServer =>
      'Le serveur de mises à jour a refusé la requête. C\'est généralement temporaire — réessayez plus tard.';

  @override
  String get geoErrorWrite =>
      'Impossible d\'écrire le fichier : pas de droits sur le dossier ou pas assez d\'espace.';

  @override
  String get geoErrorCorrupt =>
      'Le fichier téléchargé n\'a pas passé la vérification — le téléchargement est corrompu. Réessayez.';

  @override
  String get geoErrorOther => 'Cela n\'a pas fonctionné. Détails ci-dessous.';
  ...
  String get geoOfferMissingSub =>
      'Sans elles, les règles de l\'abonnement par pays et par catégorie ne fonctionneront pas — ce trafic passera par le VPN et non en direct.';

  @override
  String get geoOfferDismiss => 'Ne plus proposer';
  ...
  @override
  String get momentJustNow => 'à l\'instant';
  ...
  @override
  String get serviceChecksMenuTitle => 'Vérifier à la connexion';

  @override
  String get serviceChecksMenuOff => 'Ne pas vérifier à la connexion';

  @override
  String get serviceChecksMenuTooltip => 'Quels services vérifier';

  @override
  String get srvInfoAutoNever =>
      'La configuration automatique n\'a pas encore testé ce serveur — lancez-la pour voir quels services fonctionnent à travers lui.';
  ...
  @override
  String get settingsSectionChecks => 'Vérification des services';

  @override
  String get settingsSectionAutotune => 'Réglage automatique';

  @override
  String get settingsSpeedRankTitle =>
      'Tenir compte du débit lors de la sélection automatique';

  @override
  String get settingsSpeedRankSub =>
      'Les candidats ayant passé la vérification des services sont en plus mesurés par téléchargement : celui qui est réellement le plus rapide passe en tête. Consomme le trafic de votre abonnement.';

  @override
  String get settingsSpeedTopNLabel => 'Serveurs mesurés en débit';

  @override
  String get settingsSpeedTopNSub =>
      'Plus une mesure de votre propre ligne : sans elle, rien à quoi comparer — 60 Mbit/s, c\'est excellent sur une ligne à 60 et médiocre sur une ligne à 300.';

  @override
  String settingsSpeedTrafficNote(Object mb) {
    return '≈$mb Mo de trafic d\'abonnement par passage';
  }

  @override
  String get settingsSpeedWarnTitle =>
      'La mesure du débit consomme le trafic de l\'abonnement';

  @override
  String settingsSpeedWarnBody(Object mb) {
    return 'Chaque passage du réglage automatique télécharge environ $mb Mo via votre abonnement : une sonde par serveur mesuré plus une sonde de votre propre ligne. Ces mégaoctets sont déduits de votre quota.';
  }

  @override
  String get settingsSpeedWarnEnable => 'Activer quand même';

  @override
  String get settingsConcurrencyTitle => 'Vérifications en parallèle';

  @override
  String get settingsConcurrencySub =>
      '1 correspond au comportement précédent : les candidats sont vérifiés strictement l\'un après l\'autre, et c\'est la valeur vers laquelle revenir si les résultats deviennent étranges. Davantage, c\'est plus rapide, mais chaque candidat lance son propre noyau : la machine est plus chargée et les mesures de latence commencent à s\'influencer mutuellement.';

  @override
  String get settingsConnectChecksTitle =>
      'Vérifier les services à la connexion';

  @override
  String get settingsConnectChecksSubOn =>
      'Un passage au moment où le tunnel monte : les puces sous le bouton montrent tout de suite ce qui s\'ouvre et ce qui ne s\'ouvre pas.';

  @override
  String get settingsConnectChecksSubOff =>
      'Les puces restent grises tant que vous ne les touchez pas vous-même.';

  @override
  String get settingsConnectCheckServices => 'Que vérifier à la connexion';

  @override
  String get settingsConnectCheckServicesSub =>
      'Un ensemble volontairement distinct de celui du réglage automatique : ce dernier cherche un serveur qui fonctionne et peut y passer longtemps, tandis que ces puces répondent à la question « est-ce que ça marche maintenant ? ».';

  @override
  String get settingsConnectChecksEmpty =>
      'Aucun service sélectionné — il n\'y aura rien à vérifier.';

  @override
  String get settingsSectionSeamless => 'Continuité';

  @override
  String get settingsSeamlessNote =>
      'Aucune de ces options ne préserve les connexions ouvertes : un autre serveur, c\'est une autre IP externe, et l\'hôte distant voit une adresse différente — un appel ou un téléchargement sera coupé de toute façon. Il s\'agit seulement d\'éviter que le réseau de la machine ne clignote.';

  @override
  String get settingsSeamlessServerTitle =>
      'Ne pas recréer le tunnel lors d\'un changement de serveur';

  @override
  String get settingsSeamlessServerSub =>
      'Seul le noyau proxy redémarre : l\'adaptateur et les routes restent en place, le réseau de la machine ne clignote pas. Le prix : les adresses de tous les serveurs de l\'abonnement sont inscrites à l\'avance hors du tunnel.';

  @override
  String get settingsSeamlessNetworkTitle =>
      'Ne pas couper le canal lors d\'un changement de réseau';

  @override
  String get settingsSeamlessNetworkSub =>
      'Wi-Fi → mobile : on vérifie d\'abord si le trafic passe encore et on ne redémarre le noyau que s\'il est mort. QUIC (hysteria2) survit seul à un changement d\'adresse. Le prix : si le canal est réellement mort, la reprise commence quelques secondes plus tard.';

  @override
  String get settingsSeamlessKeepTunTitle =>
      'Garder l\'adaptateur actif entre les tentatives';

  @override
  String get settingsSeamlessKeepTunSub =>
      'La route par défaut n\'est pas secouée pendant la reprise. ⚠️ Ce n\'est PAS un kill switch : le trafic hors VPN n\'est pas bloqué — seul l\'adaptateur est maintenu.';

  @override
  String get autoSpeedTrafficTitle => 'Le test de débit consommera des données';

  @override
  String autoSpeedTrafficBody(int servers, int mb) {
    return 'Le débit sera mesuré pour les $servers meilleurs serveurs et pour votre propre connexion — environ $mb Mo du trafic de votre abonnement.\n\nVous pouvez désactiver le test dans les paramètres.';
  }
  ...
  String get noRealIpSubRulesOnly =>
      'Ne réécrit que vos règles « Direct » : elles passent par le tunnel (les sites RU aussi). L’itinéraire par défaut reste inchangé ; le réseau local reste direct.';

  @override
  String get noRealIpOnlySelectedNote =>
      'En mode « Seulement les éléments cochés », tout ce qui n’est pas coché sort toujours avec votre IP réelle — cette option n’y change rien.';

  @override
  String get infoNoRealIp =>
      'S’applique UNIQUEMENT aux règles « Direct » explicites (applications et sites) et aux règles directes de la configuration du panneau : elles sont ramenées dans le tunnel. Une règle dont « Autoriser l’IP réelle » est cochée reste directe.\n\nCe qu’elle ne fait PAS : elle ne change pas l’itinéraire par défaut. En mode « Seulement les éléments cochés », l’itinéraire par défaut reste direct : tout le trafic non coché sort donc avec votre adresse réelle, quelle que soit cette option. S’il faut tout couvrir, utilisez « Tout via le VPN ».\n\nLe réseau local reste toujours direct.';

  @override
  String get killSwitchSubProxyNoAdmin =>
      'Ce n’est pas un vrai blocage : en mode « Proxy système », aucun droit administrateur n’est demandé et tout ce qui est fait consiste à laisser le proxy configuré. Les programmes qui l’ignorent et tout l’UDP sortent directement. Seul le mode TUN retient tout.';

  @override
  String get killSwitchOfferTun =>
      'Un blocage complet pendant une coupure n’existe qu’en mode TUN.';

  @override
  String get splitOnlySelectedWarnTitle =>
      'Tout ce qui n’est pas coché sort avec votre IP réelle';

  @override
  String get splitOnlySelectedWarnBody =>
      'Seules les entrées avec l’action « Tunnel » passent par le tunnel. Tout le reste du trafic — y compris des programmes dont vous ignorez l’existence — sort directement, avec votre adresse réelle. Si tout l’appareil doit être masqué, choisissez « Tout via le VPN ».';

  @override
  String get splitOnlySelectedNoRealIp =>
      'L’option « Ne pas sortir avec l’IP réelle » n’y change rien : elle ne réécrit que les règles « Direct », pas l’itinéraire par défaut.';
  ...
  @override
  String get notifOffTitle => 'Les notifications sont désactivées';

  @override
  String get notifOffSub =>
      'Vous ne verrez pas une coupure de connexion et le bouton « Déconnecter » disparaîtra';

  @override
  String get notifOffOpen => 'Activer';
  ...
  @override
  String get updatesChannelStable => 'Canal stable';

  @override
  String get updatesChannelBeta => 'Canal bêta';

  @override
  String get updatesCheckNow => 'Vérifier maintenant';

  @override
  String get updatesStatusChecking => 'Vérification…';

  @override
  String get updatesStatusUpToDate => 'Vous avez la dernière version';
  ...
  @override
  String get updatesStatusVerifying => 'Vérification de la signature…';

  @override
  String get updatesStatusReady => 'Prêt à installer';

  @override
  String get updatesStatusInstalling => 'Installation…';
  ...
  @override
  String get updatesStatusLinkOnly => 'Installez manuellement';

  @override
  String get updatesModeTitle => 'Comment mettre à jour';

  @override
  String get updatesModeAsk => 'Demander';

  @override
  String get updatesModeAskHint =>
      'Affiche les nouveautés et n\'installe qu\'après votre accord';

  @override
  String get updatesModeAuto => 'Automatiquement';

  @override
  String get updatesModeAutoHint =>
      'Télécharge et installe tout seul quand le VPN est éteint';

  @override
  String get updatesModeNotify => 'Notifier seulement';

  @override
  String get updatesModeNotifyHint =>
      'Signale la nouvelle version sans rien télécharger ni installer';

  @override
  String get updatesAutoCheck => 'Vérifier au démarrage';

  @override
  String get updatesBeta => 'Recevoir les versions bêta';

  @override
  String get updatesSignatureNote =>
      'Chaque fichier est vérifié par la signature du développeur et une somme de contrôle ; sans correspondance, l\'installation ne démarre pas';
  ...
  @override
  String get updatesInstall => 'Mettre à jour';

  @override
  String get updatesLater => 'Plus tard';

  @override
  String get updatesSkipVersion => 'Ignorer cette version';

  @override
  String get updatesVpnWarning => 'L\'installation coupera la connexion VPN';

  @override
  String get updatesAndroidUnknownSources =>
      'Autorisez l\'installation depuis cette application';

  @override
  String get updatesAndroidOpenSettings => 'Ouvrir les réglages';

  @override
  String get updatesAndroidNoSilent =>
      'Android affichera la fenêtre d\'installation du système : c\'est une exigence du système';

  @override
  String get updatesPortableFallback =>
      'Cette copie n\'a pas été installée via l\'installateur. Téléchargez la nouvelle version manuellement';
  ...
  String get updatesInstallFailedTitle =>
      'L\'installation ne s\'est pas terminée';

  @override
  String updatesInstallFailedBody(String version) {
    return 'La version est restée $version. Journal de l\'installateur ci-dessous';
  }

  @override
  String get updatesShowLog => 'Afficher le journal';

  @override
  String get updatesOverrideBadge =>
      'Source des mises à jour remplacée (mode test)';

  @override
  String get updatesSettingsTile => 'Mises à jour';

  @override
  String get updatesSettingsTileSubtitle =>
      'Vérification, téléchargement et installation des nouvelles versions';

  @override
  String get updatesPreviousVersions => 'Versions précédentes';

  @override
  String get updatesInstallOlder => 'Installer';

  @override
  String get updatesDowngradeWarning =>
      'Retour à une version plus ancienne. Continuer ?';
  ...
  String get updatesVpnWarningBody =>
      'L\'application va se fermer et le VPN sera coupé pendant l\'installation. Reconnectez-vous après la mise à jour';

  @override
  String get updatesOpenPage => 'Ouvrir la page de téléchargement';

  @override
  String get updatesLinkNotify =>
      'Le mode « Notifier seulement » est sélectionné : téléchargez la nouvelle version depuis la page de téléchargement';

  @override
  String get updatesLinkNoSelfUpdate =>
      'Cette version ne contient pas d\'installateur signé pour votre système : téléchargez-le depuis la page de téléchargement';

  @override
  String get updatesLinkIsolated =>
      'Ceci est une copie de test isolée : elle ne modifie pas l\'application installée. Mettez à jour manuellement';

  @override
  String get updatesLinkLocation =>
      'L\'application n\'est pas lancée depuis son dossier d\'installation : téléchargez la nouvelle version manuellement ou lancez la copie installée';

  @override
  String get updatesLinkElevated =>
      'L\'application est lancée en tant qu\'administrateur : une mise à jour dans ce cas n\'est pas sûre. Lancez-la normalement';

  @override
  String get updatesLinkUnsupported =>
      'Sur cette plateforme, l\'application ne peut pas se mettre à jour seule : téléchargez la nouvelle version manuellement';

  @override
  String get updatesErrCheck => 'le serveur de mises à jour n\'a pas répondu';

  @override
  String get updatesErrInsecure =>
      'l\'adresse de téléchargement n\'est pas sécurisée (pas https)';

  @override
  String get updatesErrAssetName =>
      'le nom de fichier de la version n\'est pas autorisé';

  @override
  String get updatesErrManifest =>
      'impossible d\'obtenir le manifeste signé de la version';

  @override
  String get updatesErrSignature =>
      'la signature ne correspond pas : le fichier a peut-être été modifié';

  @override
  String get updatesErrManifestRejected =>
      'le manifeste de la version ne correspond pas à cette version ou à ce système';

  @override
  String get updatesErrDownload =>
      'le fichier n\'a pas été téléchargé ou sa somme de contrôle ne correspond pas';

  @override
  String get updatesErrInstall => 'l\'installateur ne s\'est pas lancé';

  @override
  String get updatesErrNotNewer =>
      'cette version n\'est pas plus récente que celle installée';

  @override
  String get updatesInfo =>
      'Ce que fait l\'application lorsqu\'une nouvelle version est trouvée. En mode automatique, l\'installation n\'interrompt jamais un VPN actif : elle attend que vous vous déconnectiez. Dans tous les modes, un fichier n\'est installé que si la signature du développeur correspond.';

  @override
  String get updatesDownload => 'Télécharger';

  @override
  String get updatesInstallNow => 'Installer maintenant';

  @override
  String get updatesWaitingVpn =>
      'Prêt à installer : l\'installation commencera après la déconnexion du VPN';

  @override
  String updatesSkippedNote(String version) {
    return 'Version $version ignorée : vous serez averti de la suivante';
  }

  @override
  String get updatesAutoNoticeTitle => 'Installation de la mise à jour';

  @override
  String updatesAutoNoticeBody(String version) {
    return 'L\'application va se fermer pendant l\'installation de la version $version';
  }
}

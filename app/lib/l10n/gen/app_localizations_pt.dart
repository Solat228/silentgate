...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get networkSoftRecoverTitle => 'Recuperação suave';

  @override
  String get networkSoftRecoverSub =>
      'Limpa os caches de DNS e ARP e remove o proxy do sistema. Não apaga nada, não precisa reiniciar';

  @override
  String get networkSoftRecoverConfirmTitle => 'Recuperação suave da rede?';

  @override
  String get networkSoftRecoverConfirmBody =>
      'Serão limpos o cache de DNS e o cache ARP, e removidos o proxy do sistema e o proxy do WinHTTP. As configurações dos adaptadores, os endereços e as rotas continuarão como estão, não será preciso reiniciar. Serão necessários direitos de administrador (UAC).';

  @override
  String get networkSoftRecoverConfirmOk => 'Limpar';

  @override
  String get networkFullResetTitle => 'Redefinição completa da rede';

  @override
  String get networkFullResetSub =>
      'Se o modo suave não ajudou. Apaga endereços estáticos, exige reinicialização';

  @override
  String get networkFullResetConfirmTitle => 'Redefinição completa da rede?';

  @override
  String get networkFullResetConfirmBody =>
      'Além da limpeza suave, o seguinte será feito.\n\n1) A concessão DHCP será liberada e solicitada novamente em TODOS os adaptadores — incluindo os comutadores virtuais do Hyper-V e do VirtualBox: a rede das suas máquinas virtuais pode cair.\n\n2) A redefinição do winsock e da pilha de IP devolve as configurações de rede aos padrões de fábrica: endereços estáticos, rotas e complementos de rede de terceiros serão apagados e terão de ser configurados novamente.\n\n3) Será necessária uma reinicialização, e até lá a rede pode funcionar pior do que agora.\n\nSerão necessários direitos de administrador (UAC).';

  @override
  String get networkFullResetConfirmOk => 'Redefinir rede';
  ...
  @override
  String get logModeAppTitle => 'Registo da aplicação';

  @override
  String get logModeAppSub =>
      'O que registar sobre as ações da própria aplicação';

  @override
  String get logModeCoreTitle => 'Registo do núcleo';

  @override
  String get logModeCoreSub =>
      'O que registar sobre o funcionamento do túnel (sing-box)';

  @override
  String get logLevelWarnLabel => 'Apenas erros';

  @override
  String get logLevelInfoLabel => 'Normal';

  @override
  String get logLevelDebugLabel => 'Detalhado';

  @override
  String get logVerboseTitle => 'Registar tudo';

  @override
  String get logVerboseSub =>
      'Ambos os registos no nível mais detalhado. Ative durante o diagnóstico: os ficheiros crescem depressa.';

  @override
  String get infoLogModeApp =>
      'Nível de detalhe do registo da aplicação (app.log): importação da subscrição, ping, ligação, erros. «Apenas erros» é o mais curto; «Normal» é como funcionava antes desta opção; «Detalhado» regista tudo, incluindo linhas de depuração. Afeta o tamanho do ficheiro muito menos do que o registo do núcleo.';
  ...
  String get appUpdatePreviousVersionsHint =>
      'A lista é o que está no GitHub Releases. Algumas versões podem faltar.';

  @override
  String get appUpdatePreviousVersionsEmpty =>
      'Lista vazia — GitHub Releases indisponível ou sem versões.';

  @override
  String get appUpdateOpenRelease => 'Abrir página da versão';
  ...
  @override
  String get homeAutoBest => 'Escolher servidor';

  @override
  String get homeAutoSession => 'Automático (melhor servidor)';

  @override
  String homeAutoBestHint(int count) {
    return 'testará todos os $count e conectará ao melhor';
  }

  @override
  String get homeAutoConfig => 'Escolher configuração';
  ...
  String get infoNetworkSoftRecover =>
      'Uma limpeza segura após uma falha da VPN: o cache de DNS, o cache ARP, o proxy do sistema e o proxy do WinHTTP. Não apaga nada e não exige reinicialização — comece por aqui. Requer direitos de administrador.';

  @override
  String get infoNetworkFullReset =>
      'Um último recurso se a recuperação suave não ajudou: à limpeza somam-se a renovação da concessão DHCP em todos os adaptadores, uma redefinição do winsock e uma redefinição da pilha de IP. Apaga endereços estáticos e rotas, quebra complementos de rede de terceiros e só passa a valer após uma REINICIALIZAÇÃO. Também afeta os comutadores virtuais do Hyper-V e do VirtualBox.';
  ...
  @override
  String get srvTileUpdatedTitle => 'Servidor atualizado';

  @override
  String srvTileUpdatedFields(Object fields) {
    return 'Alterado na última atualização da assinatura: $fields';
  }
  ...
  @override
  String get srvFieldEncryption => 'Criptografia';

  @override
  String get srvFieldSecurity => 'Segurança da conexão';

  @override
  String get srvFieldSni => 'SNI';

  @override
  String get srvFieldHost => 'Cabeçalho Host';

  @override
  String get srvFieldPath => 'Caminho';

  @override
  String get srvFieldPublicKey => 'Chave pública Reality';
  ...
  @override
  String get srvFieldObfs => 'Ofuscação';

  @override
  String get srvFieldObfsPassword => 'Senha de ofuscação';

  @override
  String get srvFieldHopPorts => 'Salto de portas';
  ...
  String get tunAutoFixNoticeText =>
      'O início silencioso do TUN está quebrado — cada ligação vai pedir privilégios de administrador';

  @override
  String get tunAutoFixAction => 'Corrigir';
  ...
  String get serviceChecksInfo =>
      'Cada serviço tem dois ícones: à esquerda, como ele abre sem VPN; à direita, o mesmo serviço com VPN; a seta entre eles mostra a mudança. A verificação «sem VPN» é feita sozinha ao abrir o aplicativo, «com VPN» logo após conectar. O anel ao redor do ícone mostra o estado: verde — abre, laranja — bloqueio por país, vermelho — inacessível, cinza — ainda não verificado. A marca no canto repete isso: ✓ abre, ! bloqueio por país, ✕ inacessível. Toque no ícone para verificar de novo. O conjunto de serviços muda pelo botão de configurações ao lado.';
  ...
  String get homeServerInfo =>
      'De onde este servidor sai: endereço, país, provedor, velocidade';
  ...
  @override
  String get logsSettingsLabel => 'Configurações de registros';

  @override
  String get logsClearAllLabel => 'Limpar todos os registros';

  @override
  String get logsDeleteCurrentLabel => 'Excluir este registro';

  @override
  String logsClearOptionApp(String size) {
    return 'Registro do aplicativo — $size';
  }

  @override
  String logsClearOptionTun(String size) {
    return 'Registro do núcleo TUN — $size';
  }

  @override
  String logsClearOptionProxy(String size) {
    return 'Registro do núcleo proxy — $size';
  }

  @override
  String logsClearOptionReports(String size) {
    return 'Relatórios antigos de suporte — $size';
  }

  @override
  String logsClearPeriod(String from, String to, String days) {
    return 'Os registros se acumulam de $from até $to ($days)';
  }
  ...
  @override
  String get logsClearConfirm => 'Limpar';
  ...
  String splitDeadPathNoticeText(String app) {
    return 'O caminho para “$app” está desatualizado — a regra não se aplicará desta vez';
  }

  @override
  String get splitDeadPathNoticeAction => 'Corrigir';
  ...
  String get notifOffSub =>
      'Não verá uma quebra de ligação e o botão «Desligar» desaparecerá';

  @override
  String get notifOffOpen => 'Ligar';

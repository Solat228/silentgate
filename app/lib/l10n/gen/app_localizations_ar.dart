...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get logModeAppTitle => 'سجل التطبيق';

  @override
  String get logModeAppSub => 'ما الذي يُسجَّل عن إجراءات التطبيق نفسه';

  @override
  String get logModeCoreTitle => 'سجل النواة';

  @override
  String get logModeCoreSub => 'ما الذي يُسجَّل عن عمل النفق (sing-box)';

  @override
  String get logLevelWarnLabel => 'الأخطاء فقط';

  @override
  String get logLevelInfoLabel => 'عادي';

  @override
  String get logLevelDebugLabel => 'مفصّل';

  @override
  String get logVerboseTitle => 'تسجيل كل شيء';

  @override
  String get logVerboseSub =>
      'كلا السجلَّين بأقصى تفصيل. فعِّله أثناء تشخيص المشكلة: حجم الملفات يكبر بسرعة.';

  @override
  String get infoLogModeApp =>
      'مستوى تفصيل سجل التطبيق (app.log): استيراد الاشتراك، البِنغ، الاتصال، الأخطاء. «الأخطاء فقط» هو الأقصر؛ «عادي» هو ما كان عليه الحال قبل هذا الإعداد؛ «مفصّل» يسجل كل شيء بما في ذلك سطور التصحيح. تأثيره في حجم الملف أقل بكثير من سجل النواة.';
  ...
  String get infoAutoReconnect =>
      'إذا انهارت النواة أو سقط الخادم أو تغيّرت الشبكة (واي-فاي ↔ كابل، الخروج من السكون، عنوان IP جديد)، يعيد التطبيق الاتصال من تلقاء نفسه. تتزايد فترات الانتظار بين المحاولات: 0.8 ث ← 3 ث ← 8 ث ← 20 ث، ثم تبقى عند 20 ث. عدد المحاولات ثماني، وبعدها يستسلم التطبيق ويعرض خطأً. أما قطع الاتصال بالزر فيلغي الاستعادة دائمًا.\n\n⚠️ عند تفعيل مفتاح الإيقاف، المحاولات لا تنفد أبدًا. ما دامت مستمرة تبقى حركة البيانات محجوبة، وإيقافها يعني إطلاقها خارج الشبكة الافتراضية — لذلك يواصل التطبيق المحاولة كل 20 ثانية حتى تُطفئ الشبكة الافتراضية بنفسك، ويذكّرك بالإخفاق مرة كل 15 دقيقة على الأكثر. والخادم الذي يعود بعد ساعة يُلتقط تلقائيًا.\n\nفي وضع «تلقائي (أفضل خادم)» لا يهدر التطبيق المحاولة الأخيرة على خادم ميت: فمنذ السابعة من أصل ثماني ينتقل إلى المرشح التالي، ويبدأ العدّ هناك من جديد.\n\nيُكتشف تغيّر الشبكة من العناوين الحقيقية للمحوّلات الأخرى: نفقنا الخاص وعناوين الخدمة (link-local) لا تُحتسب، ولا يُقبل التغيير إلا إذا استمر في استطلاعين متتاليين، وتُتجاهل الإشارة في أول 15 ثانية بعد الاتصال. بدون هذه الاحتياطات كان رفع النفق نفسه يُحتسب «تغيّر شبكة» ويسبب إعادة اتصال لا تنتهي.';
  ...
  String get tunLogLevelDebugCost =>
      'في مستوى debug تكتب النواة مئات الأسطر في الثانية: يغطي السجل دقائق لا ساعات وينمو بالميغابايت. لا يفيد في انقطاع حدث سابقًا — راجع سجل التطبيق.';
  ...
  String get serviceChecksInfo =>
      'لكل خدمة أيقونتان\n• اليسار: الخدمة بدون VPN\n• اليمين: نفس الخدمة عبر VPN\n• السهم بينهما: التغيّر\n\nمتى يُؤخذ القياس\n• بدون VPN: تلقائيًا عند تشغيل التطبيق\n• عبر VPN: فور الاتصال\n\nلون الحلقة حول الأيقونة\n• أخضر: تُفتح\n• برتقالي: حجب حسب الدولة\n• أحمر: غير متاحة\n• رمادي: لم تُفحص بعد\n\nالعلامة في الزاوية تكرر اللون\n• ✓ تُفتح\n• ! حجب حسب الدولة\n• ✕ غير متاحة\n\nما يمكن الضغط عليه\n• الأيقونة: إعادة فحص الخدمة\n• زر الإعدادات المجاور: تغيير مجموعة الخدمات';

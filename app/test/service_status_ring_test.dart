...
void main() {
  ...
  test('подпись группы не шире ячейки — иначе она душит размер значков', () {
    // Ширину блока задаёт самый широкий элемент. Пока подпись шире содержимого,
    // увеличивать значки бесполезно: сторона упирается в неё, а не в них.
    expect(ServiceChecksSides.labelWidthFor(false), lessThanOrEqualTo(48.0),

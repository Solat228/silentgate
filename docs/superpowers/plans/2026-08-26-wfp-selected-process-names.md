...
### Задача 1: Модель плана и чистая материализация имён
...
### Задача 2: Передача селекторов через файл плана
...
### Задача 3: Разделение правил приложения на имена и пути
...
### Задача 4: Материализация и наблюдение в `TunHelper`
...
### Задача 5: Полная статическая проверка и регрессионный аудит
...
### Задача 6: Живая проверка только в `SG-Test`
